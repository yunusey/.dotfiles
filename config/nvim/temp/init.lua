-- This file is my setup before starting using lazy.nvim.
-- Packer manager used is packer.nvim
...
require('packer').startup(function(use)
   ...
   use 'folke/tokyonight.nvim'      -- tokyonight-storm
   ...
   dap.adapters.python = {
       type = 'executable';
       command = '/home/yucely/.virtualenvs/debugpy/bin/python3';
   ...
   use '~/.config/nvim/lua/telescope.nvim'
   ...
   -- Bookmarks for telescope-nvim
   use '~/.config/nvim/lua/telescope-bookmarks.nvim'
