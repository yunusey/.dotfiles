...
local function cmake_build(on_exit_function)
	local buf = nil
	local split = false
...
local function cmake_config(on_exit_function)
	local buf = nil
	local split = false
...
vim.api.nvim_create_user_command("EnterProject", enter_cmake, {})
vim.api.nvim_create_user_command("ConfigBuildProject", function() cmake_config(cmake_build) end, {})
vim.api.nvim_create_user_command("BuildProject", function() cmake_build(nil) end, {})
vim.api.nvim_create_user_command("ConfigProject", function() cmake_config(nil) end, {})
vim.api.nvim_create_user_command("RunProject", function() cmake_run() end, {})
vim.api.nvim_create_user_command("BuildRunProject", function() cmake_build(cmake_run) end, {})
